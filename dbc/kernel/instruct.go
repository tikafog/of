...
func (*Instruct) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		...
		default:
			return nil, fmt.Errorf("unexpected column %q for type metaInstruct", columns[i])
		}
	}
	return values, nil
}
...
func (i *Instruct) Unwrap() *Instruct {
	...
	if !ok {
		panic("kernel: metaInstruct is not a transactional entity")
	}
...
func (i *Instruct) String() string {
	...
	builder.WriteString("metaInstruct(")
