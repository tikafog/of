...
func Open(path string, opts ...Opts) (*DBC, error) {
	o := opt(opts)
	cliB, err := open[*bootnode.Client](of.NameBootNode, path, o)
	if err != nil {
		return nil, err
	}

	cliK, err := open[*kernel.Client](of.NameKernel, path, o)
	if err != nil {
		return nil, err
	}

	cliU, err := open[*upgrade.Client](of.NameKernel, path, o)
	if err != nil {
		return nil, err
	}

	cliM, err := open[*media.Client](of.NameMedia, path, o)
	if err != nil {
		return nil, err
	}
