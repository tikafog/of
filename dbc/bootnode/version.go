...
func (*Version) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		switch columns[i] {
		case version.FieldID, version.FieldCurrent, version.FieldLast:
...
func (v *Version) Unwrap() *Version {
	...
	if !ok {
		panic("bootnode: Version is not a transactional entity")
	}
...
func (v *Version) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", v.Current))
	builder.WriteString(", Last=")
	builder.WriteString(fmt.Sprintf("%v", v.Last))
	builder.WriteByte(')')
