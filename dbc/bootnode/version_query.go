...
func (vgb *VersionGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(vgb.fields) > 1 {
		return nil, errors.New("bootnode: VersionGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := vgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (vgb *VersionGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{version.Label}
	default:
		err = fmt.Errorf("bootnode: VersionGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (vgb *VersionGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(vgb.fields) > 1 {
		return nil, errors.New("bootnode: VersionGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := vgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (vgb *VersionGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{version.Label}
	default:
		err = fmt.Errorf("bootnode: VersionGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (vgb *VersionGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(vgb.fields) > 1 {
		return nil, errors.New("bootnode: VersionGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := vgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (vgb *VersionGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{version.Label}
	default:
		err = fmt.Errorf("bootnode: VersionGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (vgb *VersionGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(vgb.fields) > 1 {
		return nil, errors.New("bootnode: VersionGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := vgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (vgb *VersionGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{version.Label}
	default:
		err = fmt.Errorf("bootnode: VersionGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (vs *VersionSelect) Strings(ctx context.Context) ([]string, error) {
	if len(vs.fields) > 1 {
		return nil, errors.New("bootnode: VersionSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := vs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (vs *VersionSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{version.Label}
	default:
		err = fmt.Errorf("bootnode: VersionSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (vs *VersionSelect) Ints(ctx context.Context) ([]int, error) {
	if len(vs.fields) > 1 {
		return nil, errors.New("bootnode: VersionSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := vs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (vs *VersionSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{version.Label}
	default:
		err = fmt.Errorf("bootnode: VersionSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (vs *VersionSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(vs.fields) > 1 {
		return nil, errors.New("bootnode: VersionSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := vs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (vs *VersionSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{version.Label}
	default:
		err = fmt.Errorf("bootnode: VersionSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (vs *VersionSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(vs.fields) > 1 {
		return nil, errors.New("bootnode: VersionSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := vs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (vs *VersionSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{version.Label}
	default:
		err = fmt.Errorf("bootnode: VersionSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
