...
func (tlq *TopListQuery) GroupBy(field string, fields ...string) *TopListGroupBy {
	group := &TopListGroupBy{config: tlq.config}
...
func (tlq *TopListQuery) Select(fields ...string) *TopListSelect {
	...
	return &TopListSelect{TopListQuery: tlq}
}
...
func (tlq *TopListQuery) sqlAll(ctx context.Context) ([]*TopList, error) {
	var (
		nodes       = []*TopList{}
		_spec       = tlq.querySpec()
		loadedTypes = [2]bool{
...
func (tlgb *TopListGroupBy) ScanX(ctx context.Context, v interface{}) {
...
func (tlgb *TopListGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(tlgb.fields) > 1 {
		return nil, errors.New("media: TopListGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := tlgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tlgb *TopListGroupBy) StringsX(ctx context.Context) []string {
...
// It is only allowed when executing a group-by query with one field.
func (tlgb *TopListGroupBy) String(ctx context.Context) (_ string, err error) {
	var v []string
	...
	case 0:
		err = &NotFoundError{toplist.Label}
	default:
		err = fmt.Errorf("media: TopListGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (tlgb *TopListGroupBy) StringX(ctx context.Context) string {
...
// It is only allowed when executing a group-by query with one field.
func (tlgb *TopListGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(tlgb.fields) > 1 {
		return nil, errors.New("media: TopListGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := tlgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tlgb *TopListGroupBy) IntsX(ctx context.Context) []int {
	v, err := tlgb.Ints(ctx)
	if err != nil {
		panic(err)
	}
...
// It is only allowed when executing a group-by query with one field.
func (tlgb *TopListGroupBy) Int(ctx context.Context) (_ int, err error) {
	var v []int
	...
	case 0:
		err = &NotFoundError{toplist.Label}
	default:
		err = fmt.Errorf("media: TopListGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (tlgb *TopListGroupBy) IntX(ctx context.Context) int {
	v, err := tlgb.Int(ctx)
	if err != nil {
		panic(err)
	}
...
// It is only allowed when executing a group-by query with one field.
func (tlgb *TopListGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(tlgb.fields) > 1 {
		return nil, errors.New("media: TopListGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := tlgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tlgb *TopListGroupBy) Float64sX(ctx context.Context) []float64 {
...
// It is only allowed when executing a group-by query with one field.
func (tlgb *TopListGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	...
	case 0:
		err = &NotFoundError{toplist.Label}
	default:
		err = fmt.Errorf("media: TopListGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (tlgb *TopListGroupBy) Float64X(ctx context.Context) float64 {
...
// It is only allowed when executing a group-by query with one field.
func (tlgb *TopListGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(tlgb.fields) > 1 {
		return nil, errors.New("media: TopListGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := tlgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (tlgb *TopListGroupBy) BoolsX(ctx context.Context) []bool {
...
// It is only allowed when executing a group-by query with one field.
func (tlgb *TopListGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	...
	case 0:
		err = &NotFoundError{toplist.Label}
	default:
		err = fmt.Errorf("media: TopListGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (tlgb *TopListGroupBy) BoolX(ctx context.Context) bool {
	v, err := tlgb.Bool(ctx)
	if err != nil {
		panic(err)
	}
...
// ScanX is like Scan, but panics if an error occurs.
func (tls *TopListSelect) ScanX(ctx context.Context, v interface{}) {
...
func (tls *TopListSelect) Strings(ctx context.Context) ([]string, error) {
	if len(tls.fields) > 1 {
		return nil, errors.New("media: TopListSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := tls.Scan(ctx, &v); err != nil {
		return nil, err
...
// StringsX is like Strings, but panics if an error occurs.
func (tls *TopListSelect) StringsX(ctx context.Context) []string {
...
func (tls *TopListSelect) String(ctx context.Context) (_ string, err error) {
	var v []string
	...
	case 0:
		err = &NotFoundError{toplist.Label}
	default:
		err = fmt.Errorf("media: TopListSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}

// StringX is like String, but panics if an error occurs.
func (tls *TopListSelect) StringX(ctx context.Context) string {
...
func (tls *TopListSelect) Ints(ctx context.Context) ([]int, error) {
	if len(tls.fields) > 1 {
		return nil, errors.New("media: TopListSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := tls.Scan(ctx, &v); err != nil {
		return nil, err
...
// IntsX is like Ints, but panics if an error occurs.
func (tls *TopListSelect) IntsX(ctx context.Context) []int {
	v, err := tls.Ints(ctx)
	if err != nil {
		panic(err)
	}
...
func (tls *TopListSelect) Int(ctx context.Context) (_ int, err error) {
	var v []int
	...
	case 0:
		err = &NotFoundError{toplist.Label}
	default:
		err = fmt.Errorf("media: TopListSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}

// IntX is like Int, but panics if an error occurs.
func (tls *TopListSelect) IntX(ctx context.Context) int {
	v, err := tls.Int(ctx)
	if err != nil {
		panic(err)
	}
...
func (tls *TopListSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(tls.fields) > 1 {
		return nil, errors.New("media: TopListSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := tls.Scan(ctx, &v); err != nil {
		return nil, err
...
// Float64sX is like Float64s, but panics if an error occurs.
func (tls *TopListSelect) Float64sX(ctx context.Context) []float64 {
...
func (tls *TopListSelect) Float64(ctx context.Context) (_ float64, err error) {
	var v []float64
	...
	case 0:
		err = &NotFoundError{toplist.Label}
	default:
		err = fmt.Errorf("media: TopListSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}

// Float64X is like Float64, but panics if an error occurs.
func (tls *TopListSelect) Float64X(ctx context.Context) float64 {
...
func (tls *TopListSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(tls.fields) > 1 {
		return nil, errors.New("media: TopListSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := tls.Scan(ctx, &v); err != nil {
		return nil, err
...
// BoolsX is like Bools, but panics if an error occurs.
func (tls *TopListSelect) BoolsX(ctx context.Context) []bool {
	v, err := tls.Bools(ctx)
	if err != nil {
		panic(err)
	}
...
func (tls *TopListSelect) Bool(ctx context.Context) (_ bool, err error) {
	var v []bool
	...
	case 0:
		err = &NotFoundError{toplist.Label}
	default:
		err = fmt.Errorf("media: TopListSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}

// BoolX is like Bool, but panics if an error occurs.
func (tls *TopListSelect) BoolX(ctx context.Context) bool {
	v, err := tls.Bool(ctx)
	if err != nil {
		panic(err)
	}
