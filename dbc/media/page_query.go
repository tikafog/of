...
func (pgb *PageGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(pgb.fields) > 1 {
		return nil, errors.New("media: PageGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := pgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (pgb *PageGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{page.Label}
	default:
		err = fmt.Errorf("media: PageGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (pgb *PageGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(pgb.fields) > 1 {
		return nil, errors.New("media: PageGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := pgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (pgb *PageGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{page.Label}
	default:
		err = fmt.Errorf("media: PageGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (pgb *PageGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(pgb.fields) > 1 {
		return nil, errors.New("media: PageGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := pgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (pgb *PageGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{page.Label}
	default:
		err = fmt.Errorf("media: PageGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (pgb *PageGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(pgb.fields) > 1 {
		return nil, errors.New("media: PageGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := pgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (pgb *PageGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{page.Label}
	default:
		err = fmt.Errorf("media: PageGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (ps *PageSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ps.fields) > 1 {
		return nil, errors.New("media: PageSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ps.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ps *PageSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{page.Label}
	default:
		err = fmt.Errorf("media: PageSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ps *PageSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ps.fields) > 1 {
		return nil, errors.New("media: PageSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ps.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ps *PageSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{page.Label}
	default:
		err = fmt.Errorf("media: PageSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ps *PageSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ps.fields) > 1 {
		return nil, errors.New("media: PageSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ps.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ps *PageSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{page.Label}
	default:
		err = fmt.Errorf("media: PageSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ps *PageSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ps.fields) > 1 {
		return nil, errors.New("media: PageSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ps.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ps *PageSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{page.Label}
	default:
		err = fmt.Errorf("media: PageSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
