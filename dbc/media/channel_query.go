...
func (cgb *ChannelGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("media: ChannelGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *ChannelGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{channel.Label}
	default:
		err = fmt.Errorf("media: ChannelGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *ChannelGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("media: ChannelGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *ChannelGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{channel.Label}
	default:
		err = fmt.Errorf("media: ChannelGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *ChannelGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("media: ChannelGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *ChannelGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{channel.Label}
	default:
		err = fmt.Errorf("media: ChannelGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *ChannelGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("media: ChannelGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *ChannelGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{channel.Label}
	default:
		err = fmt.Errorf("media: ChannelGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *ChannelSelect) Strings(ctx context.Context) ([]string, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("media: ChannelSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *ChannelSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{channel.Label}
	default:
		err = fmt.Errorf("media: ChannelSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *ChannelSelect) Ints(ctx context.Context) ([]int, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("media: ChannelSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *ChannelSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{channel.Label}
	default:
		err = fmt.Errorf("media: ChannelSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *ChannelSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("media: ChannelSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *ChannelSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{channel.Label}
	default:
		err = fmt.Errorf("media: ChannelSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *ChannelSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("media: ChannelSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *ChannelSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{channel.Label}
	default:
		err = fmt.Errorf("media: ChannelSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
